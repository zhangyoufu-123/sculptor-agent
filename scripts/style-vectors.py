...
def fig_ability():
    ...
    d.text((W // 2, 70), 'w = (0.25, 0.20, 0.20, 0.20, 0.15)；SCULPTOR 各维来自实测（20+11 套 QA / 反 AI 审计 / 人类化指标）', font=SUB, fill='#6f5f4b', anchor='mm')
...
lines += [
    '',
    '注：SCULPTOR 的"人类化/反AI味/全流程"来自实测（20+11 套 QA、反 AI 审计真实修复案例、'
